...
{
    public class SQLServerDALV3 : SQLServerDAO
    {
        ...
        public bool GetOrdersForXMLBatch(out DataTable dt)
        {
            ...
            try
            {
                intPhase = 0;
                oCmd = new SqlCommand();
                oCmd.CommandText = "GetDroppedOrders";
        ...
        public SqlConnection Connection
        {
            ...
            get
            {
                ...
                try
                {
                    this.ClearErrors();
                    intPhase = -1;
                    if (_Connection == null) { _Connection = new SqlConnection(Helper.SQLServerDAO["version3"].ToString()); }
                    intPhase = -2;
