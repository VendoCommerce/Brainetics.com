...
{
    public class SQLServerNoNoSkin : SQLServerDAO
    {
        SqlConnection _Connection = null;
        private const string _FILENAME = "SQLServerNoNoSkin.cs";
        ...
        public SqlConnection Connection
        {
            ...
            get
            {
                ...
                try
                {
                    this.ClearErrors();
                    intPhase = -1;
                    if (_Connection == null) { _Connection = new SqlConnection(Helper.SQLServerDAO["NoNoSkin"].ToString()); }
                    intPhase = -2;
