...
{
    public class SQLServerDALAcneComplexVersion3 : SQLServerDAO
    {
        ...
        public SqlConnection Connection
        {
            ...
            get
            {
                ...
                try
                {
                    this.ClearErrors();
                    intPhase = -1;
                    if (_Connection == null) { _Connection = new SqlConnection(Helper.SQLServerDAO["AcneComplexVersion3"].ToString()); }
                    intPhase = -2;
