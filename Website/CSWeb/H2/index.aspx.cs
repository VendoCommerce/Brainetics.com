    ...
    public partial class index : CSWebBase.SiteBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (CSWeb.OrderHelper.GetVersionName().ToLower().Equals("h2") || CSWeb.OrderHelper.GetVersionName().ToLower().Equals("k2") || CSWeb.OrderHelper.GetVersionName().ToLower().Equals("m2"))
                {
