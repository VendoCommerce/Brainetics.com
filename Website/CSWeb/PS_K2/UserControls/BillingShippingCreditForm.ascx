...
<asp:ScriptManager runat="server" ID="sm1">
    ...
    <a name="tryitnow" id="tryitnow"></a>
        <div class="cartA"><img src="//d1f7jvrzd4fora.cloudfront.net/images/k2/form_top_cart.png" width="279" height="117" />        
            ...
            <div class="form_line clearfix">
                ...
                <label class="label-1">
                    Phone*</label>
                <asp:TextBox ID="txtPhoneNumber1" runat="server" MaxLength="16" CssClass="text-4"></asp:TextBox>
     ...
     <asp:CheckBox ID="cbShippingSame" runat="server" CssClass="checkbox-left" OnCheckedChanged="cbShippingSame_CheckedChanged"
            ...
            <div class="form_line clearfix" style="padding: 10px 0">
                <asp:CheckBox ID="cbOffers" runat="server"  CssClass="checkbox-left" />
                <label class="label-2">
