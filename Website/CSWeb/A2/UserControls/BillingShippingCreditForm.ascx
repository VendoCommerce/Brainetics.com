<%@Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.A2.UserControls.BillingShippingCreditForm" CodeBehind="BillingShippingCreditForm.ascx.cs" %>
<asp:ScriptManager runat="server" ID="sm1">
</asp:ScriptManager>
    <a name="tryitnow" id="tryitnow"></a>
        <div class="cartA"><img src="//d1f7jvrzd4fora.cloudfront.net/images/a2/form_top.jpg" width="279" height="117" />        
...
Special Offers from Contour!
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="//d1f7jvrzd4fora.cloudfront.net/images/a2/ordernow_btn.jpg" OnClick="imgBtn_OnClick" />
            </div>
