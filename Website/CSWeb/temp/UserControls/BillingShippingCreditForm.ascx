<%@Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.temp.UserControls.BillingShippingCreditForm" CodeBehind="BillingShippingCreditForm.ascx.cs" %>
<%@ Register Src="ShoppingCartControl.ascx" TagName="ShoppingCartControl"
    ...
    <a name="tryitnow" id="tryitnow"></a>
        <div class="cartA"><img src="/Content/Images/temp/form_top.jpg" width="279" height="117" />        
...
Special Offers from Contour!
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="/Content/images/temp/ordernow_btn.jpg" OnClick="imgBtn_OnClick" />
            </div>
