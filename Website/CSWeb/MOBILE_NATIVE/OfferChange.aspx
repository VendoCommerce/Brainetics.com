<%@Page Language="C#" AutoEventWireup="true" Inherits="CSWeb.Mobile_NATIVE.Store.OfferChange" EnableSessionState="True" %>
...
<link href="/styles/expirestyles_mobile.css" rel="stylesheet" type="text/css" />
</head>

<body>
    <form runat="server" id="fm1">
<div id="expire" class="overlay" style="height: 1150px;">
<div class="overlay_top"><a href="javascript:void(0);" onclick="parent.jQuery.fancybox.close();" class="close_overlay">close <span class="closex">X</span></a></div>
