<%@Control Language="C#" AutoEventWireup="true" CodeBehind="ShippingCreditForm.ascx.cs" Inherits="CSWeb.BRAINETICS_YT.UserControls.ShippingCreditForm" %>
...
<h2>
          ...
          as Shipping</label>
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="//d1f7jvrzd4fora.cloudfront.net/images/b2/try_it_now_btn.png"
