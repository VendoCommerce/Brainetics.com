<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CardDecline.ascx.cs" Inherits="CSWeb.BRAINETICS_YT.UserControls.CardDecline" %>
...
<div id="receipt_content"  style="height: auto; width: 950px; position:relative;padding: 30px 60px;color: #5c5c5c;">
    ...
    <asp:RadioButtonList ID="rblUpdateBillingAddress" runat="server" OnSelectedIndexChanged="rblUpdateBillingAddress_CheckedChanged"
        ...
        <asp:ListItem Value="false" Selected="True">No</asp:ListItem>
            ...
            <div class="form_line clearfix">
                <label class="label-3">
                    Card Verification #* <a class="cvv" href="//d1f7jvrzd4fora.cloudfront.net/images/a5/cvv.png" style="display:none">what's this?</a>
                </label>
                <div class="error-2">
