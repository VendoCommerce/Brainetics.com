<%@Page Language="C#" AutoEventWireup="true" Inherits="CSWeb.BRAINETICS_YT.Store.OfferChange" EnableSessionState="True" %>
...
<h2>Attention!</h2>
 ...
 <h3><img src="//d1f7jvrzd4fora.cloudfront.net/images/d2/expire_arrow.png" width="31" height="28" style="float:left; margin-top: 8px; margin-left: 2px;" />&nbsp;Please select your preference:</h3>
 ...
 <div class="formline_expire"> <asp:ImageButton runat="server" ImageUrl="//d1f7jvrzd4fora.cloudfront.net/images/d2/btn_continue.png" width="195" height="53" OnClick="BindSkus"/> 
 </div>
</div>  
