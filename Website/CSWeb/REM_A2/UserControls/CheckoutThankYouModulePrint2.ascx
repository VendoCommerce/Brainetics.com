<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckoutThankYouModulePrint2.ascx.cs" Inherits="CSWeb.REM_A2.UserControls.CheckoutThankYouModulePrint2" %>
