...
<div class="cartB"><img src="//d1f7jvrzd4fora.cloudfront.net/images/header__top_june19.jpg" />
    ...
    <div class="form_line clearfix">
        ...
        <asp:Label class="label-1" Text="Address*" runat="server" ID="lblAddress"/>
  ...
  <div id="offerdet" style="display:block;"><p><strong>Offer Details:</strong>  As part of this special TV Offer you are getting to try Brainetics in the comfort of your home for a trial fee of $14.95 plus FREE shipping and handling. If you decide to keep the system, simply do nothing and beginning in 30 days following the date of your purchase you will be charged 3 easy monthly payments of $49.95, plus tax. All orders are backed by our 30-Day Money-Back Guarantee!</p></div>
