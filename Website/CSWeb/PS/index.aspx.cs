            ...
            SitePreference  sitePrefCache = CSFactory.GetCacheSitePref();
                ...
                if (sitePrefCache.GetAttributeValue("PS_Redirect_Ver").ToString()  != null)
                {
                    ...
                    if (!redirect_version.Equals(""))
                        ...
                        {
                            Response.Redirect("https://golo.com/" + redirect_version +"/"+ GetCurrentPageName() + "?" + Request.QueryString);  
                        }
                        else
                        {
                            Response.Redirect("https://golo.com/" + redirect_version + "/" +GetCurrentPageName() );
                        }
                }
