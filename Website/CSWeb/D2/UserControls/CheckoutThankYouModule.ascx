<%@ Control Language="C#" Inherits="CSWeb.D2.UserControls.CheckoutThankYouModule" %>
    ...
    <div id="receipt_content"  style="height: auto; width: 950px; position:relative;padding: 30px 60px;color: #5c5c5c;">
        ...
        <img src="//d1f7jvrzd4fora.cloudfront.net/images/d2/receipt_rebatecall.jpg" usemap="#receipt_offer">
    ...
    <area shape="rect" coords="513,303,736,366" href="javascript:void(0)" onclick="open_book_rebate();" />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="receipt_table1">
            ...
            <tr><td colspan="4"><p>As part of our special TV Offer you can try Brainetics in the comfort of your home for only $14.95 plus 
                                    FREE shipping and handling. If you decide to keep the system, simply do nothing and beginning in 30 days following the date of your purchase you will be charged 4 easy monthly payments of $49.95, plus tax. All orders are backed by our 60-Day Money-Back Guarantee!</p></td></tr>
            <tr class="horzline2">
                <td valign="top">&nbsp;
