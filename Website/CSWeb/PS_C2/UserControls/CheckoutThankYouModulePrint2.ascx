<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckoutThankYouModulePrint2.ascx.cs" Inherits="CSWeb.PS_C2.UserControls.CheckoutThankYouModulePrint2" %>
