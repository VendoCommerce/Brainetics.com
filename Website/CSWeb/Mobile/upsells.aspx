...
<!-- accelerated pkg - 4pay -->
<div class="page_upsell">
<div class="upsell_txt">
<h2 class="f34 webfont1" style="line-height: 46px;">Boost Your Success With Brainetics <br />
Accelerated Package!</h2>

<p>Upgrade to Brainetics Accelerated package today for the same $14.95 trial fee and you'll also get:  </p>  
<ul class="ul_upsell">
<li>The Challenge Game, a fun way to drill your Brainetics techniques</li>
<li>The Quick Card Set for easy access to the DVD's concepts</li>
...
<!-- accelerated pkg - 1pay -->
<div class="page_upsell">
<div class="upsell_txt">
<h2 class="f34 webfont1" style="line-height: 46px;">Boost Your Success With Brainetics <br />
Accelerated Package!</h2>

<p>Upgrade to the Brainetics Accelerated One-Pay package today for an additional $74.85. That's a 29% Savings over its regular price! </p>  
<ul class="ul_upsell">
<li>The Challenge Game, a fun way to drill your Brainetics techniques</li>
<li>The Quick Card Set for easy access to the DVD's concepts</li>
<li>Access to the Online Language Lab and the Complete Brainetics      Digital Experience which allows you to access Brainetics anywhere! </li></ul>
...
<!-- additional playbook - 1pay -->
<div class="page_upsell">
<div class="upsell_txt">
<h2 class="f36 webfont1" style="line-height: 43px;">Be Prepared to Keep Your Child <br />
...
<div class="page_upsell">
<div class="upsell_txt">
<h2 class="f41 webfont1" style="line-height: 48px;">SAVE 25% and Create the <br>
Best Learning Environment <br />
  with Sound Health</h2>
...
<div class="page_upsell">
<div class="upsell_txt">
<h2 class="f35 webfont1" style="line-height: 50px;">Get Started with Brainetics ASAP!<br />
Upgrade to Rush Shipping Now!</h2>
<p>You want your child to start getting excited about learning and doing math. Wouldn’t it be even better if you got started in just a few days? Upgrade to either 2-Day shipping for $39.95 or Overnight shipping for $79.96 and we’ll ship your Brainetics kit right away!</p>
<div class="rush_bg"><p><strong>Get your child started with Brainetics <br>
as quickly as you can –  upgrade to<br>
