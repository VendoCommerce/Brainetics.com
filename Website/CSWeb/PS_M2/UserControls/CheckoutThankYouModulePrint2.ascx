<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckoutThankYouModulePrint2.ascx.cs" Inherits="CSWeb.PS_M2.UserControls.CheckoutThankYouModulePrint2" %>
