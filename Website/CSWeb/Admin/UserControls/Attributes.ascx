...
<asp:Repeater ID="rptAttributes" runat="server" OnItemDataBound="rptAttributes_ItemDataBound">
    <HeaderTemplate>
        <table border="0" cellpadding="4" cellspacing="0" style="width: <%= WidthTotal.ToString() %>px;">
            <tr>
                <td class="attributesBorderBtm" style="width: 150px;">
                    <strong>Name</strong>
                </td>
                <td class="attributesBorderBtm">
                    <strong>Value</strong>
                </td>    
                <td class="attributesBorderBtm" style="width: 25px;">
    ...
    <ItemTemplate>
        ...
        <tr>
            ...
            <td class="attributesBorderBtm">
                <asp:TextBox ID="txtAttributeValue" runat="server" Visible="false" style="width: 250px;" />
