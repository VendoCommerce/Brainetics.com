<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SIDReport.aspx.cs" Inherits="CSWeb.Admin.SIDReport" EnableSessionState="True" %>
        ...
        <div id="header2">
            ...
            <div id="report_nav">
                <a href="VersionReport.aspx">Version Report</a> | <a href="Reports.aspx">
                    Standard Report</a> | <span class="current">SID Report</span>
            </div>
            <div id="log_link">
