                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblShippingId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ShippingId") %>'
                                        Visible="False" />
                                    <asp:TextBox ID="txtOrderItem" runat="server" Width="50px" style="width: 50px;" MaxLength="4" Text='<%# String.Format("{0:0.##}", DataBinder.Eval(Container.DataItem, "OrderTotal")) %>' />
                                </td>
                                <td>
                                    $<asp:TextBox ID="txtCostItem" runat="server" Width="50px" style="width: 50px;" MaxLength="6" Text='<%# String.Format("{0:0.##}", DataBinder.Eval(Container.DataItem, "Cost")) %>' />
                    ...
                    <asp:Repeater ID="rptSkuItem" runat="server" OnItemDataBound="rptSkuItem_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    $<asp:TextBox ID="txtPercentage" runat="server" Width="50px" style="width: 50px;" MaxLength="6" />
