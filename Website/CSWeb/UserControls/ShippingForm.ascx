...
<div class="cartB">
    ...
    <div class="form_line clearfix">
        ...
        <label class="label-1">
            Phone Number*</label>
        <asp:TextBox ID="txtPhone1" runat="server" MaxLength="3" CssClass="text-2" TabIndex="10"></asp:TextBox>
        <asp:TextBox ID="txtPhone2" runat="server" MaxLength="3" CssClass="text-2" TabIndex="11"></asp:TextBox>
        <asp:TextBox ID="txtPhone3" runat="server" MaxLength="4" CssClass="text-3" TabIndex="12"></asp:TextBox>
    </div>
    <div class="form_line clearfix">
        <div class="error-1">
    ...
    <div class="form_line_btn">
        <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="//d1f7jvrzd4fora.cloudfront.net/images/ordernow_btn.jpg" OnClick="imgBtn_OnClick" />
   </div>
