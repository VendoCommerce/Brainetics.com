...
<%@ Register Src="ShoppingCartControl.ascx" TagName="ShoppingCartControl"
    ...
    <a name="tryitnow" id="tryitnow"></a>
        <div class="cartA"><img src="/Content/Images/A3/form_top.jpg" width="279" height="117" />        
...
Special Offers from Contour!
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="/Content/images/A3/ordernow_btn.jpg" OnClick="imgBtn_OnClick" />
            </div>
