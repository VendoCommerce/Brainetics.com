<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BillingCreditForm.ascx.cs"
    Inherits="CSWeb.A3.UserControls.BillingCreditForm" %>
...
<div class="cart_content_B clearfix">
    ...
    <div class="cart_right">
        ...
        <div class="cartB"><img src="//d1f7jvrzd4fora.cloudfront.net/images/a3/cart_form_top.jpg" width="293" height="56" />
...
<label><span class="black bold">Accelerated Package</span></label>
   ...
   <label class="label-1" style="width: 70px">Quantity: </label>
           ...
           <div class="form_line text-center"><img src="//d1f7jvrzd4fora.cloudfront.net/images/a3/cards.jpg" width="246" height="41" /></div>
         ...
         <asp:CheckBox ID="cbBillingDifferent" runat="server" CssClass="checkbox-left" OnCheckedChanged="cbBillingDifferent_CheckedChanged"
            ...
            <div class="form_line clearfix">
             <div class="error-1">
                ...
                <asp:TextBox ID="txtCvv" runat="server" CssClass="text-2" MaxLength="4"></asp:TextBox><a class="cvv" href="//d1f7jvrzd4fora.cloudfront.net/images/a3/cvv.png" onclick="javascript:void(0);">What's this?</a>
            </div>
            <div class="form_line clearfix"> <div class="error-1">
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="//d1f7jvrzd4fora.cloudfront.net/images/a3/tryitnow_btn.png"
