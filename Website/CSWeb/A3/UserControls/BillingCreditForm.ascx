...
<label><span class="black bold">Accelerated Package</span></label>
   ...
   <label class="label-1" style="width: 70px">Quantity: </label>
           ...
           <div class="form_line text-center"><img src="/Content/images/A3/cards.jpg" width="246" height="41" /></div>
         ...
         <asp:CheckBox ID="cbBillingDifferent" runat="server" CssClass="checkbox-left" OnCheckedChanged="cbBillingDifferent_CheckedChanged"
            ...
            <div class="form_line clearfix">
             <div class="error-1">
                ...
                <asp:TextBox ID="txtCvv" runat="server" CssClass="text-2" MaxLength="4"></asp:TextBox><a class="cvv" href="/content/images/A3/cvv.png" onclick="javascript:void(0);">What's this?</a>
            </div>
            <div class="form_line clearfix"> <div class="error-1">
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="/content/images/A3/tryitnow_btn.png"
         ...
         <img src="/Content/images/A3/truste.png" />&nbsp;&nbsp;<img src="" alt="norton">
         </div>
        </div>
    <!-- end cartB -->
</div>
