<%@ Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.A4.UserControls.ShippingForm" CodeBehind="ShippingForm.ascx.cs" %>
<a name="tryitnow" id="tryitnow"></a>
<div class="cartB"><img src="//d1f7jvrzd4fora.cloudfront.net/images/a4/form_top.png" />
    ...
    <div class="form_line_btn">
        <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="//d1f7jvrzd4fora.cloudfront.net/images/a4/tryitnow_btn.png" OnClick="imgBtn_OnClick" />
   </div>
