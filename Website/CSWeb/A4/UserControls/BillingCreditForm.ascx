...
<div class="cart_content_B clearfix">
    ...
    <div class="cart_right">
        ...
        <div class="cartB"><img src="/Content/images/A4/cart_form_top.jpg" width="293" height="56" />
...
<label><span class="black bold">Accelerated Package</span></label>
  ...
  <asp:LinkButton ID="lbUpdate" runat="server" OnClick="lbUpdate_Click" CausesValidation="true" ValidationGroup="QuantityUpdate" CssClass="update_btn">Update</asp:LinkButton>
           ...
           <div class="form_line text-center"><img src="/Content/images/A4/cards.jpg" width="246" height="41" /></div>
