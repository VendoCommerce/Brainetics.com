...
<asp:ScriptManager runat="server" ID="sm1">
    ...
    <a name="tryitnow" id="tryitnow"></a>
        <div class="cartA"><img src="/Content/Images/A4/form_top.jpg" width="279" height="117" />        
...
Special Offers from Contour!
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="/Content/images/A4/ordernow_btn.jpg" OnClick="imgBtn_OnClick" />
            </div>
