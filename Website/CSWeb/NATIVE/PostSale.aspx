<%@ Page Language="C#" AutoEventWireup="true" Inherits="CSWeb.O2.Store.PostSale"
    EnableEventValidation="false" EnableSessionState="true" %>
    <%@ Register Src="/o2/UserControls/header.ascx" TagName="Header_Cart" TagPrefix="uc" %>
<%@ Register Src="/o2/UserControls/Footer.ascx" TagName="Footer" TagPrefix="uc" %>
