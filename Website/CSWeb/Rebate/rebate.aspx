...
<div class="formline clearfix">    <div class="error">  
     ...
     <div class="formline" style="text-align:right; padding-right: 63px;">        
            <asp:ImageButton runat="server" ID="imgButton" OnClick="imgbtnOnClick" ValidationGroup="group1" ImageUrl="//d1f7jvrzd4fora.cloudfront.net/images/d2/submit_rebate_btn.jpg" />
</div>
